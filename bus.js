  ...
  var task = [
    ...
    function(possibleBusArr, callback) {
      ...
      if (possibleBusArr[0].similarity == 0) {
        ...
        console.log("similarity: " + util.getSimilarStrings(msg,  basicConv.agreementArr, -1, basicConv.agreementArr.length)[0].similarity);
        if (util.getSimilarStrings(msg,  basicConv.agreementArr, -1, basicConv.agreementArr.length)[0].similarity == 1) {
          callback(null);
        } else {
